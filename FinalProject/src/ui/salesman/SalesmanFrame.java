...
public class SalesmanFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new SalesmanContentPanel());
                    break;
    ...
    public SalesmanFrame(Person curPerson) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesmanFrame.class
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("sd_store", "Duty Free Loung", 0)
                )
        );
    }
}
