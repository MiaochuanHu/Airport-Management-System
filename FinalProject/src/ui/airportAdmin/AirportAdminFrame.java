 ...
 * @author limingxia
 */
public class AirportAdminFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new FlightCompanyManagement(true));
                    break;
                case 1:
                    showContent(new FlightManagement(true));
                    break;
                case 2:
                    showContent(new PassengerManagement());
                    break;
                case 3:
                    showContent(new AirportStaffManagement());
                    break;
            }
        }
    ...
    public AirportAdminFrame(Person curPerson) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AirportAdminFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AirportAdminFrame().setVisible(true);
            }
        });
    }
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("sd_flight_comapny", "Flight Company", 0),
                        new FuncItem("sd_flight", "Flight", 1),
                        new FuncItem("sd_passenger", "Passenger", 2),
                        new FuncItem("sd_users", "Staff", 3)
                )
        );
    }
}
