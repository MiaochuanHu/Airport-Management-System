...
public class SystemAdminFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new FlightCompanyManagement());
                    break;
                case 1:
                    showContent(new FlightManagement());
                    break;
                case 2:
                    showContent(new GovernManagement());
                    break;
                case 3:
                    showContent(new PersonManagement());
                    break;
            }
        }
    ...
    public SystemAdminFrame(Person curPerson) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemAdminFrame.class
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        ...
                        new FuncItem("sd_government", "Government", 2),
                        new FuncItem("sd_users", "Users", 3)
                )
        );
    }
}
