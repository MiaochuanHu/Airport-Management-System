...
public class PersonManagement extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchAreaBgLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, searchAreaBgLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(keywordTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        List<Person> searchResult = persons.stream().filter(a
    ...
    private void personTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_personTableMouseClicked
        ...
        nameLbl.setText(selectedPerson.getPersonName());
        accountLbl.setText(selectedPerson.getAccount());
        genderLbl.setText(selectedPerson.getGender());
        ageTxt.setText(selectedPerson.getAge() + "");
        roleLbl.setText(selectedPerson.getRoleType());
    ...
    private void addBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBtnMouseClicked
        SignUpFrame signUpFrame = new SignUpFrame("PersonManagement");
    ...
    private void delBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delBtnMouseClicked
        ...
        if (person.getRoleType().equals(RoleEnum.SYSTEM_ADMIN.getRole())
                || person.getRoleType().equals(RoleEnum.AIRBUS_ADMIN.getRole())
                || person.getRoleType().equals(RoleEnum.AIRPORT_ADMIN.getRole())
                || person.getRoleType().equals(RoleEnum.SERVICE_ADMIN.getRole())
                || person.getRoleType().equals(RoleEnum.GOVERN_ADMIN.getRole())) {

            JOptionPane.showMessageDialog(this, "Cannot Delete Admin!");
            return;
        }

        if (!PersonDao.deletePersonByPid(person.getPersonID())) {
    ...
    private void initPersonList() {
        persons = PersonDao.queryAllPerson();
    }
