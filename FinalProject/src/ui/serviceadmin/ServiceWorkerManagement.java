 ...
 * @author limingxia
 */
public class ServiceWorkerManagement extends javax.swing.JPanel {

    private List<Person> serviceStaff = new ArrayList<>();
    private Person selectedStaff;

    /**
     * Creates new form AirlineManagement
     */
    public ServiceWorkerManagement() {
        initComponents();
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        List<Person> searchResult = serviceStaff.stream().filter(a
    ...
    private void addBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBtnMouseClicked
        SignUpFrame signUpFrame = new SignUpFrame("ServiceWorkerManagement");
    ...
    private void initServiceStaffs() {
        serviceStaff = PersonDao.queryAllServiceStaff();
    }
