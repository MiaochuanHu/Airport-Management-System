 ...
 * @author limingxia
 */
public class ServiceAdminFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new ServiceWorkerManagement());
                    break;
    ...
    public ServiceAdminFrame(Person curPerson) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiceAdminFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServiceAdminFrame().setVisible(true);
            }
        });
    }
