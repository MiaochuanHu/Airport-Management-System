...
public class PilotFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            ...
            switch (index) {
                case 0:
                    showContent(new PilotATCcommandPanel());
                    break;
                default:
     ...
     */
    public PilotFrame() {   
        curPerson.setAccount("pilot@gmail.com");
        curPerson.setRoleType(RoleEnum.FLIGHTCREW.getRole());
    ...
    public PilotFrame(Person curPerson) {
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("search", "ATC Command", 0)
                )
        );
    }
}
