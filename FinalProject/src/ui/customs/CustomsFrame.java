 ...
 * @author limingxia
 */
public class CustomsFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new CustomsContentPanel());
                    break;
    ...
    public CustomsFrame(Person curPerson) {
    ...
    private void initComponents() {
        ...
        customsContentPanel1 = new ui.customs.CustomsContentPanel();
        ...
        contentPanel.add(customsContentPanel1, java.awt.BorderLayout.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(contentPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 726, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(6, 6, 6)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomsFrame().setVisible(true);
            }
        });
    }
    ...
    private ui.customs.CustomsContentPanel customsContentPanel1;
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("sd_customs", "Border Inspection", 0)
                )
        );
    }
}
