 ...
 * @author limingxia
 */
public class AirTrafficControllerFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            ...
            switch (index) {
                case 0:
                    showContent(new AirTrafficControllerStatusPanel());
                    break;
                case 1:
                    showContent(new AirTrafficControllerCommandPanel());
                    break;
                default:
    ...
    public AirTrafficControllerFrame() {
        curPerson.setAccount("atc@gmail.com");
        curPerson.setRoleType(RoleEnum.TRAFFICCONTROL.getRole());
        initFuncItemList();
        initComponents();
     ...
     public AirTrafficControllerFrame(Person p){
        this.curPerson = p;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AirTrafficControllerFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AirTrafficControllerFrame().setVisible(true);
            }
        });
    }
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("search", "Flight Status", 0),
                        new FuncItem("edit", "Command Paneal", 1)
                )
        );
    }
}
