...
import model.Person;
import ui.HomePage;
import ui.companyadmin.AddNewCompanyFlight;
import ui.companyadmin.ComFlightManagement;
...
public class TicketFrame extends javax.swing.JFrame {
    ...
    */
    public TicketFrame() {
        curPerson.setAccount("conductor@gmail.com");
        curPerson.setRoleType("Conductor");
        initFuncItemList();
        initComponents();
        
        sideBarPanel.initMenu(funcItemList, new TicketFrame.TicketEvent(), new TicketFrame.ExitEvent());
    }
    
    public TicketFrame(Person p){
        curPerson = p;
            initFuncItemList();
        initComponents();
    ...
    private class TicketEvent implements ui.component.CustomEvent {
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("ticketsell", "Tickets Selling", 0)
                )
        );
    }
    /**
