 ...
 * @author limingxia
 */
public class GreeterFrame extends javax.swing.JFrame {
    ...
    private class FuncEvent implements ui.component.CustomEvent {
        ...
        public void funcItemSelected(int index) {
            switch (index) {
                case 0:
                    showContent(new GreeterContentPanel());
                    break;
            }
        }
    ...
    public GreeterFrame(Person curPerson) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GreeterFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GreeterFrame().setVisible(true);
            }
        });
    }
    ...
    private void initFuncItemList() {
        this.funcItemList = new ArrayList<>(
                Arrays.asList(
                        new FuncItem("sd_vip", "VIP Lounge", 0)
                )
        );
    }
}
